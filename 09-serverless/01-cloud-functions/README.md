...
mínimo y máximo pasados como carga JSON de la request ([functions.py](functions.py), [main.py](main.py)):
...
Declara en [requirements.txt](requirements.txt) las dependencias necesarias
(`functions-framework`, entre otras).

El despliegue de dicha *function* es bastante sencillo, como se puede comprobar en
...
vamos a usar, i.e. `Python 3.13`, así como una
